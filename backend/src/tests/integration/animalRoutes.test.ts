...
describe('Animal Routes', () => {
  ...
  describe('GET /api/animals/farm/:farmId', () => {
    ...
    test('debería manejar errores al obtener animales', async () => {
      ...
      expect(response.body).toHaveProperty('error', 'Error al obtener animales');
  ...
  describe('POST /api/animals', () => {
    ...
    test('debería devolver 400 si faltan campos obligatorios', async () => {
      ...
      expect(response.body).toHaveProperty('error', 'farm_id y animal_type son obligatorios');
    });
    ...
    test('debería devolver 404 si la granja no existe', async () => {
      ...
      expect(response.status).toBe(404);
      expect(response.body).toHaveProperty('error', 'La granja especificada no existe');
    });
  });
