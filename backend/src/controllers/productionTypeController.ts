...
export const createProductionType = async (req: Request, res: Response) => {
  try {
    ...
    const savedProductionType = await productionTypeRepository.save(
      newProductionType
    );
    return res
      .status(201)
      .json({
        ...
        productionType: savedProductionType,
      });
  } catch (error) {
...
export const getAllProductionTypes = async (req: Request, res: Response) => {
  try {
    ...
    return res
      .status(500)
      .json({ error: "Error al obtener tipos de producción" });
  }
};
...
export const getProductionTypeById = async (req: Request, res: Response) => {
  try {
    ...
    if (!productionType) {
      return res
        .status(404)
        .json({ error: "Tipo de producción no encontrado" });
    }
    ...
    return res
      .status(500)
      .json({ error: "Error al obtener tipo de producción" });
  }
};
...
export const updateProductionType = async (req: Request, res: Response) => {
  try {
    ...
    const updatedProductionType = await productionTypeRepository.save(
      productionType
    );
    return res.json({
      message: "Tipo de producción actualizado",
      productionType: updatedProductionType,
    });
  } catch (error) {
    console.error("Error actualizando tipo de producción:", error);
    return res
      .status(500)
      .json({ error: "Error al actualizar tipo de producción" });
  }
};
...
export const deleteProductionType = async (req: Request, res: Response) => {
  try {
    ...
    return res
      .status(500)
      .json({ error: "Error al eliminar tipo de producción" });
  }
};
